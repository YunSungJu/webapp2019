<?php
	...
	function loadSetting($id) {
		$db = new PDO("mysql:dbname=custom;host=13.124.181.241;port=3306","root","11111111"); // passwoar, ip 
...
<?php
	...
	try {
		$db = new PDO("mysql:dbname=custom;host=13.124.181.241;port=3306","root","11111111"); //프로젝트에는 실제 mysql의 id, password 입력
		$db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		$id = $_POST['id'];
		$pw = $_POST['password'];
